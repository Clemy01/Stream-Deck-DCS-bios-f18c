...
var pages = {
  MAIN: {
	...
	4: { type: 'page', page: 'F18C', image: 'F18C.png' },
   ...
   15: { type: 'ledButton', button: 'WEAPONS_GROUND_TARGET_BTN', led: 'WEAPONS_GROUND_TARGET_LED', upImage: 'WEAP_mov_gnd_off.png', downImage: 'WEAP_mov_gnd_on.png' }
    ...
    F18C:	{
  	...
  	2: { type: 'page', page: 'MAIN', image: 'main-page.png' },
	3: { type: 'switch', button: 'COM_ILS_UFC_MAN_SW', led: 'COM_ILS_UFC_MAN_SW', upImage: 'rwrpwroff.png', downImage: 'rwrpwron.png' }
  },
